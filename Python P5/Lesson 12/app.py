...
def upload():
    ...
    blog1["data"][str(len(blog1["data"]))] = {"title": title, "username": username, "description": shortDescription, "catagory": catagory, "photo": os.path.join(app.config["UPLOAD_FOLDER"], picture.filename), "content": actualContent}
